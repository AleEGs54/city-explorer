...
import { getLocalStorage, toggleItemInStorage } from "./localStorageManagement.mjs";
...
<div class="place-details-container">
  ...
  <div class="place-details-mainInformation">
    ...
    <a href="https://www.google.com/maps/search/?api=1&query=${place.displayName}&query_place_id=${place.id}">
 ...
 */
export function attachCardIconListeners() {
  const cards = document.querySelectorAll('.card');
